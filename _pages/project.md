...
### Deep Genomics — RNA Foundation Models

#### BigRNA, REPRESS, and Enigma

As part of the AI-Enabled Target Discovery group at Deep Genomics, I contributed to the development and deployment of three large-scale neural network models for RNA biology.

**[BigRNA](https://doi.org/10.1101/2023.09.20.558508)** is an RNA foundation model trained on diverse transcriptomic data to learn generalizable representations of gene expression and RNA processing. It enables discovery of disease mechanisms and identification of candidate therapeutic targets from sequence alone.

**[REPRESS](https://doi.org/10.1101/2025.05.15.654105)** is a sequence-based model for predicting cell-type-specific microRNA binding and mRNA degradation, designed for therapeutic target discovery across disease-relevant cell types.

**[Enigma](https://doi.org/10.64898/2025.12.18.694875)** is an efficient model for deciphering regulatory genomics, scaling sequence-based regulatory prediction across the genome.

My contributions span model benchmarking and evaluation, large-scale inference infrastructure on GCP (GPU/TPU), and productionizing these models as internal tools used across the organization.
